...
page_1="http://192.168.1.1/sqlite_platform/src/login/index.html"
page_2="http://192.168.1.1/sqlite_platform/src/profile/index.php"
page_3="http://192.168.1.1/sqlite_platform/src/login/proc.php"
...
echo $total_time
echo "$1,$(echo $total_time/$1 | bc -l)" >> $dest_test
